...
try {
    ...
    if (!$auth->isLoggedIn() || !$auth->isAdmin()) {
        error_log("Unauthorized access attempt in delete_user.php");
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        error_log("Invalid request method in delete_user.php: " . $_SERVER['REQUEST_METHOD']);
        echo json_encode(['success' => false, 'message' => 'Invalid request method']);
    }
} catch (Exception $e) {
    error_log("Critical error in delete_user.php: " . $e->getMessage());
